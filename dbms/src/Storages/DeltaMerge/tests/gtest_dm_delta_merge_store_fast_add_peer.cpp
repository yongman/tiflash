...
INSTANTIATE_TEST_CASE_P(
    ...
    DeltaMergeStoreTestFastAddPeer,
    testing::Values(
        std::make_tuple(NullspaceID, STORAGE_FORMAT_V5, STORAGE_FORMAT_V5), // V6 -> V6
        std::make_tuple(NullspaceID, STORAGE_FORMAT_V5, STORAGE_FORMAT_V7), // V6 -> V7
        std::make_tuple(NullspaceID, STORAGE_FORMAT_V7, STORAGE_FORMAT_V7), // V7 -> V7
        std::make_tuple(300, STORAGE_FORMAT_V5, STORAGE_FORMAT_V5), // V6 -> V6
        std::make_tuple(300, STORAGE_FORMAT_V5, STORAGE_FORMAT_V7), // V6 -> V7
