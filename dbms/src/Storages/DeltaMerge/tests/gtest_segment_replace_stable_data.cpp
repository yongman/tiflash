...
try
{
    ...
    SegmentPtr wn_segment_v1{};
    {
        ...
        auto new_dm_file = DMFile::restore(
            wn_dm_context->global_context.getFileProvider(),
            file->fileId(),
            file->pageId(),
            file->parentPath(),
            DMFileMeta::ReadMode::all(),
        ...
        auto iw = DMFileV3IncrementWriter::create(DMFileV3IncrementWriter::Options{
            .dm_file = new_dm_file,
            .file_provider = wn_dm_context->global_context.getFileProvider(),
            .write_limiter = wn_dm_context->global_context.getWriteLimiter(),
            .path_pool = storage_path_pool,
