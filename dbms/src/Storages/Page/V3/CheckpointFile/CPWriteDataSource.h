...
public:
     ...
     */
    explicit CPWriteDataSourceBlobStore(BlobStore<universal::BlobStoreTrait> & blob_store_, size_t prefetch_size_)
    ...
    {
        return std::make_shared<CPWriteDataSourceBlobStore>(blob_store, prefetch_size);
    }
